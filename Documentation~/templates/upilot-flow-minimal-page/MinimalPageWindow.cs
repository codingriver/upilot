...
{
    public sealed class MinimalPageWindow : EditorWindow, IUPilotFlowTestHostWindow
    {
        ...
        private void BuildUi()
        {
            ...
            {
                throw new UPilotFlowException(ErrorCodes.RootElementMissing, "MinimalPageWindow is missing required named elements.");
            }
