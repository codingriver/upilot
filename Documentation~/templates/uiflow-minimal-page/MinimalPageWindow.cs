...
{
    public sealed class MinimalPageWindow : EditorWindow, IUIFlowTestHostWindow
    {
        ...
        private void BuildUi()
        {
            ...
            {
                throw new UIFlowException(ErrorCodes.RootElementMissing, "MinimalPageWindow is missing required named elements.");
            }
