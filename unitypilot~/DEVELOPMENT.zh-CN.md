...
本文档面向维护 `upilot` 随包 Python MCP server 的开发者。普通用户安装与基础使用请先阅读根目录 `../README.zh-CN.md`。

英文版 `DEVELOPMENT.md` 是默认开发文档；本文是对应的中文版本。
...
- 根目录英文 README：`../README.md`
- 根目录中文 README：`../README.zh-CN.md`
- 本文档英文版：`DEVELOPMENT.md`
