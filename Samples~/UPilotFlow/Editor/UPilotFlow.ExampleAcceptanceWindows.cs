...
namespace CodingRiver.UPilot.Flow.Examples
{
    ...
    public abstract class ExampleAcceptanceWindowBase : EditorWindow, IUPilotFlowTestHostWindow
    {
        ...
        protected void BuildUi()
        {
            ...
            if (common == null)
            {
                throw new UPilotFlowException(ErrorCodes.RootElementMissing, $"Missing USS asset: {ExampleAssetPaths.CommonUss}");
            }
