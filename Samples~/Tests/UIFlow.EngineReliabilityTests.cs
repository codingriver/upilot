...
{
    public sealed class UIFlowEngineReliabilityTests : UIFlowFixture<SampleLoginWindow>
    {
        [UnityTest]
        public IEnumerator CancellationToken_CancelsRunAsyncImmediately()
        {
            ...
            {
                Assert.That(ex, Is.TypeOf<System.OperationCanceledException>().Or.TypeOf<UIFlowException>());
            });
        }
