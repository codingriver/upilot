...
namespace codingriver.upilot.UIFlow
{
    ...
    public sealed class UIFlowImguiTests
    {
        ...
        {
            Assert.Throws<UIFlowException>(() => ImguiSelectorCompiler.Compile(""));
            Assert.Throws<UIFlowException>(() => ImguiSelectorCompiler.Compile("not_a_selector"));
        }
