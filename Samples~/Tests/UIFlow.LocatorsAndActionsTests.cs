...
{
    public sealed class UIFlowLocatorFixtureTests : UIFlowFixture<SampleLoginWindow>
    {
        [UnityTest]
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteYamlStepsAsync(
        ...
        public IEnumerator ClickAction_OnLoginButton_UpdatesStatusLabel()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ClickAction(), new Dictionary<string, string>
            {
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new FocusAction(), new Dictionary<string, string>
            {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SetValueAction(), new Dictionary<string, string>
            {
                ["selector"] = "#username-input",
                ["value"] = "bob",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertValueAction(), new Dictionary<string, string>
            {
                ["selector"] = "#username-input",
                ["expected"] = "bob",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertEnabledAction(), new Dictionary<string, string>
            {
                ["selector"] = "#login-button",
            }));
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertDisabledAction(), new Dictionary<string, string>
            {
                ["selector"] = "#login-button",
            }));
        }
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertVisibleAction(), new Dictionary<string, string>
            {
                ["selector"] = "#login-button",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertTextAction(), new Dictionary<string, string>
            {
                ["selector"] = "#status-label",
                ["expected"] = "Idle",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertTextContainsAction(), new Dictionary<string, string>
            {
                ["selector"] = "#status-label",
                ["expected"] = "Id",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertNotVisibleAction(), new Dictionary<string, string>
            {
                ["selector"] = "#toast-message",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new WaitAction(), new Dictionary<string, string>
            {
                ["duration"] = "50ms",
            }));
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new WaitForElementAction(), new Dictionary<string, string>
            {
                ["selector"] = "#toast-message",
                ["timeout"] = "1000ms",
            }));
    ...
    public sealed class UIFlowActionFixtureTests : UIFlowFixture<SampleInteractionWindow>
    {
        [UnityTest]
        ...
        public IEnumerator TypeTextAndPressKeyActions_UpdateWindowState()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(typeTask);
            ...
            yield return UIFlowTestTaskUtility.Await(pressKeyTask);
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new PressKeyAction(), new Dictionary<string, string>
            {
                ["key"] = "A",
            }));
        ...
        public IEnumerator ExecuteAndValidateCommandActions_DispatchCommandEvents()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ValidateCommandAction(), new Dictionary<string, string>
            {
                ["command"] = "Copy",
            }));
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ExecuteCommandAction(), new Dictionary<string, string>
            {
                ["command"] = "Paste",
            }));
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new HoverAction(), new Dictionary<string, string>
            {
                ["selector"] = "#hover-target",
                ["duration"] = "50ms",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ScrollAction(), new Dictionary<string, string>
            {
                ["selector"] = "#scroll-view",
                ["delta"] = "0,120",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new DragAction(), new Dictionary<string, string>
            {
                ["from"] = "10,10",
                ["to"] = "80,80",
                ["duration"] = "64ms",
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new OpenContextMenuAction(), new Dictionary<string, string>
            {
                ["selector"] = "#context-menu-target",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertMenuItemAction(), new Dictionary<string, string>
            {
                ["item"] = "Copy",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertMenuItemDisabledAction(), new Dictionary<string, string>
            {
                ["item"] = "Delete",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectContextMenuItemAction(), new Dictionary<string, string>
            {
                ["item"] = "Copy",
            }));
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new OpenPopupMenuAction(), new Dictionary<string, string>
            {
                ["selector"] = "#popup-menu-dropdown",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectPopupMenuItemAction(), new Dictionary<string, string>
            {
                ["item"] = "Option2",
            }));
        ...
        {
            string screenshotPath = Path.Combine(Path.GetTempPath(), "UIFlowTests", System.Guid.NewGuid().ToString("N") + ".png");
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new TypeTextFastAction(), new Dictionary<string, string>
            {
                ["selector"] = "#interaction-input",
                ["value"] = "fast",
            }));
        ...
        public IEnumerator PressKeyCombinationAction_SendsShortcut()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new TypeTextAction(), new Dictionary<string, string>
            {
                ["selector"] = "#interaction-input",
                ["value"] = "selectme",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new PressKeyCombinationAction(), new Dictionary<string, string>
            {
                ["keys"] = "Ctrl+A",
            }));
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertPropertyAction(), new Dictionary<string, string>
            {
                ["selector"] = "#interaction-input",
                ["property"] = "maxLength",
                ["expected"] = "-1",
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ScreenshotAction(), new Dictionary<string, string>
            {
    ...
    public sealed class UIFlowOfficialIntegrationTests
    {
        [Test]
        public void SimulationSession_CapturesInputSystemTextEvents()
        {
            ...
            using (var session = new UIFlowSimulationSession())
            {
    ...
    public sealed class UIFlowFixtureIntegrationBoundaryTests
    {
        [UnityTest]
    ...
    public sealed class UIFlowStrictPointerFixtureTests : UIFlowFixture<SampleInteractionWindow>
    {
    ...
    public sealed class UIFlowStrictKeyboardFixtureTests : UIFlowFixture<SampleInteractionWindow>
    {
        protected override TestOptions CreateDefaultOptions()
        {
            TestOptions options = base.CreateDefaultOptions();
        ...
        public IEnumerator TypeTextAction_StrictKeyboardMode_DisablesDirectWriteFallback()
        {
            ...
            {
                UIFlowException flowException = ex as UIFlowException;
    ...
    public sealed class UIFlowStrictHostModeTests
    {
        [UnityTest]
    ...
    public sealed class UIFlowAdvancedControlsFixtureTests : UIFlowFixture<AdvancedControlsWindow>
    {
        [UnityTest]
        public IEnumerator AdvancedControlActions_UpdateControlState()
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectOptionAction(), new Dictionary<string, string>
            {
                ["selector"] = "#choice-dropdown",
                ["value"] = "Beta",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ToggleFoldoutAction(), new Dictionary<string, string>
            {
                ["selector"] = "#settings-foldout",
                ["expand"] = "true",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SetSliderAction(), new Dictionary<string, string>
            {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectListItemAction(), new Dictionary<string, string>
            {
                ["selector"] = "#item-list",
                ["index"] = "2",
            }));
        ...
        public IEnumerator ToggleMaskOptionAction_TogglesIndividualBits()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ToggleMaskOptionAction(), new Dictionary<string, string>
            {
                ["selector"] = "#feature-mask",
                ["index"] = "1",
            }));
        ...
        public IEnumerator SelectOptionAction_FailsForMissingChoice()
        {
            ...
            Assert.That(task.Exception.Flatten().InnerException, Is.TypeOf<UIFlowException>());
            Assert.That(((UIFlowException)task.Exception.Flatten().InnerException).ErrorCode, Is.EqualTo(ErrorCodes.ActionOptionNotFound));
        }
        ...
        public IEnumerator SortAndResizeColumnActions_UpdateMultiColumnViews()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SortColumnAction(), new Dictionary<string, string>
            {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ResizeColumnAction(), new Dictionary<string, string>
            {
                ["selector"] = "#scene-tree",
                ["index"] = "0",
                ["width"] = "240",
        ...
        public IEnumerator BoundValueActions_ProvideHigherLevelPropertyAndInspectorAutomation()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SetBoundValueAction(), new Dictionary<string, string>
            {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertBoundValueAction(), new Dictionary<string, string>
            {
                ["selector"] = "#property-title-field",
                ["property"] = "inspectorTitle",
        ...
        public IEnumerator NavigateBreadcrumbAndUnifiedMenuActions_Work()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new NavigateBreadcrumbAction(), new Dictionary<string, string>
            {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new MenuItemAction(), new Dictionary<string, string>
            {
                ["selector"] = "#toolbar-menu",
                ["kind"] = "popup",
                ["mode"] = "select",
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectTreeItemAction(), new Dictionary<string, string>
            {
                ["selector"] = "#navigation-tree",
                ["id"] = "120",
            }));

            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectTabAction(), new Dictionary<string, string>
            {
        ...
        {
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new DragReorderAction(), new Dictionary<string, string>
            {
                ["selector"] = "#item-list",
                ["from_index"] = "1",
                ["to_index"] = "3",
        ...
        public IEnumerator PageScrollerAndSetSplitViewSizeActions_Work()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new PageScrollerAction(), new Dictionary<string, string>
            {
                ["selector"] = "#standalone-scroller",
                ["direction"] = "down",
                ["pages"] = "2",
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new SetSplitViewSizeAction(), new Dictionary<string, string>
            {
        ...
        public IEnumerator CloseTabAction_ClosesSpecifiedTab()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new CloseTabAction(), new Dictionary<string, string>
            {
                ["selector"] = "#settings-tabs",
                ["label"] = "About",
            }));
        ...
        public IEnumerator DragScrollerAction_UpdatesScrollerValue()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new DragScrollerAction(), new Dictionary<string, string>
            {
                ["selector"] = "#standalone-scroller",
                ["ratio"] = "0.5",
                ["duration"] = "64ms",
        ...
        public IEnumerator ReadBreadcrumbsAction_PopulatesSharedBag()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ReadBreadcrumbsAction(), new Dictionary<string, string>
            {
                ["selector"] = "#toolbar-breadcrumbs",
                ["bag_key"] = "crumbs",
            }));
        ...
        public IEnumerator ClickPopupItemAction_UpdatesPopupFieldValue()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteActionAsync(new ClickPopupItemAction(), new Dictionary<string, string>
            {
                ["selector"] = "#quick-popup",
                ["value"] = "South",
            }));
        ...
        public IEnumerator AssertMenuItemActions_FailForMissingItem()
        {
            ...
            yield return UIFlowTestTaskUtility.AwaitFailure(assertTask, ex =>
            {
        ...
        public IEnumerator WaitAction_BoundaryDurations()
        {
            ...
            UIFlowException ex = Assert.Throws<UIFlowException>(() =>
            {
        ...
        public IEnumerator TypeTextAction_OnNonInputElement_ThrowsOrFails()
        {
            ...
            yield return UIFlowTestTaskUtility.AwaitFailure(task, ex =>
            {
                Assert.That(ex, Is.TypeOf<UIFlowException>().Or.TypeOf<System.Exception>());
            });
        }
    }
}
