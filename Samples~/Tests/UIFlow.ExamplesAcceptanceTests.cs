...
using codingriver.upilot.UIFlow.Examples;

namespace codingriver.upilot.UIFlow
{
    public sealed class UIFlowExamplesAcceptanceTests
    {
        [Test]
...
";
            ...
            Assert.That(definition.Fixture.HostWindow.Type, Is.EqualTo("codingriver.upilot.UIFlow.Examples.ExampleBasicLoginWindow"));
        ...
        public IEnumerator HostWindowManager_ReopensWindowAndClearsDirtyState()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(openFirstTask, tuple =>
            {
            ...
            yield return UIFlowTestTaskUtility.Await(openSecondTask, tuple =>
            {
        ...
        public IEnumerator HostWindowManager_CallsPrepareForAutomatedTest()
        {
            ...
            yield return UIFlowTestTaskUtility.Await(openTask, tuple =>
            {
                window = tuple.window;
            });
