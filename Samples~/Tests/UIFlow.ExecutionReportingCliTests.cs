...
{
    public sealed class UIFlowExecutionFixtureTests : UIFlowFixture<SampleLoginWindow>
    {
        [UnityTest]
...
";
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteYamlStepsAsync(yaml, "continue-on-step-failure.yaml"), result =>
            {
...
";
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteYamlStepsAsync(yaml, "timeout-case.yaml"), result =>
            {
                Assert.That(result.Status, Is.EqualTo(TestStatus.Failed));
...
";
            ...
            yield return UIFlowTestTaskUtility.Await(ExecuteYamlStepsAsync(yaml, "fixture-context.yaml"), result =>
            {
    ...
    public sealed class UIFlowReportingAndCliTests
    {
        [Test]
        ...
        public void CommandLineParser_PrefersCliValuesOverConfig()
        {
            ...
            string configPath = Path.Combine(tempDir, ".uiflow.json");
...
");
            ...
            {
                "Unity.exe",
                "-uiFlow.configFile", configPath,
                "-uiFlow.headed", "false",
                "-uiFlow.reportPath", "CliReports",
                "-uiFlow.screenshotOnFailure", "true",
                "-uiFlow.defaultTimeoutMs", "3000",
                "-uiFlow.preStepDelayMs", "120",
                "-uiFlow.requireOfficialHost", "false",
                "-uiFlow.requireOfficialPointerDriver", "false",
                "-uiFlow.requireInputSystemKeyboardDriver", "false",
            };
...
");
        ...
        public void CommandLineParser_ToTestOptions_MapsStrictFlags()
        {
            ...
            {
                "Unity.exe",
                "-uiFlow.requireOfficialHost", "true",
                "-uiFlow.requireOfficialPointerDriver", "true",
                "-uiFlow.requireInputSystemKeyboardDriver", "true",
                "-uiFlow.preStepDelayMs", "240",
            });
        ...
        public void CommandLineParser_RejectsDuplicateArguments()
        {
            ...
            UIFlowException ex = Assert.Throws<UIFlowException>(() => new CommandLineOptionsParser().Parse(args));
        ...
        public void CommandLineParser_RejectsExplicitYamlPathAndDirectoryTogether()
        {
            ...
            {
                "Unity.exe",
                "-uiFlow.yamlPath", "Assets/Examples/Yaml/01-basic-login.yaml",
                "-uiFlow.yamlDirectory", "Assets/Examples/Yaml",
            };
        ...
        public void ProjectSettings_AlwaysEnableVerboseLog_OverridesRuntimeFlags()
        {
            ...
            try
            {
                ...
                TestOptions resolved = UIFlowProjectSettingsUtility.ApplyOverrides(new TestOptions
                {
                    Headed = true,
        ...
        {
            HashSet<string> assemblies = UIFlowConfigResolver.GetCustomActionAssemblyWhitelist();
            var registry = new ActionRegistry();

            Assert.That(assemblies, Does.Contain("Assembly-CSharp"));
            Assert.That(assemblies, Does.Contain("UIFlow.Tests"));
        ...
        public void ConfigFileLoader_ThrowsOnInvalidYaml()
        {
            ...
            UIFlowException ex = Assert.Throws<UIFlowException>(() => new ConfigFileLoader().Load(badPath));
        ...
        public void CommandLineParser_ResolvesComplexPriority()
        {
            ...
            string[] args = { "Unity.exe", "-uiFlow.headed", "true", "-uiFlow.reportPath", "Cli" };
...
");
            ...
            {
                "Unity.exe",
                "-uiFlow.yamlPath", yamlPath,
                "-uiFlow.reportPath", tempDir,
                "-uiFlow.headed", "false",
            };

            Task<int> task = UIFlowCliEntry.RunAllAsync(args);
        ...
        {
            string path = Path.Combine(Path.GetTempPath(), "UIFlowTests", System.Guid.NewGuid().ToString("N"));
