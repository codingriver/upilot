...
namespace codingriver.upilot.UIFlow
{
    public static class SampleWindowAssetLoader
    {
        public static void RebuildWindow(EditorWindow window, string uxmlPath, string ussPath)
        {
            if (window == null)
            {
                throw new UIFlowException(ErrorCodes.RootElementMissing, "Sample window is null.");
            }
            ...
            if (styleSheet == null)
            {
                throw new UIFlowException(ErrorCodes.RootElementMissing, $"Missing USS asset: {ussPath}");
            }
    ...
    /// <summary>
    /// Sample window used by UIFlow examples and tests.
    /// </summary>
    public sealed class SampleLoginWindow : EditorWindow
    {
        ...
        [MenuItem("upilot/UIFlow/Samples/Login Window")]
        ...
        public void BuildUi()
        {
            ...
            {
                throw new UIFlowException(ErrorCodes.RootElementMissing, "Sample login UXML is missing required elements.");
            }
    ...
    public sealed class SampleInteractionWindow : EditorWindow
    {
        ...
        [MenuItem("upilot/UIFlow/Samples/Interaction Window")]
        public static void Open()
        {
        ...
        public void BuildUi()
        {
            ...
            {
                throw new UIFlowException(ErrorCodes.RootElementMissing, "Sample interaction UXML is missing required elements.");
            }
    ...
    public sealed class CustomLoginAction : IAction
    {
        public async Task ExecuteAsync(VisualElement root, ActionContext context, Dictionary<string, string> parameters)
        {
            ...
            {
                throw new UIFlowException(ErrorCodes.ActionTargetTypeInvalid, "custom_login target type is not assignable.");
            }
