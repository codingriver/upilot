...
namespace UnityUIFlow
{
    ...
    public sealed class UnityUIFlowProjectSettings : ScriptableSingleton<UnityUIFlowProjectSettings>
    {
    ...
    public static class UnityUIFlowProjectSettingsUtility
    {
    ...
    public static class UnityUIFlowProjectSettingsProvider
    {
        [SettingsProvider]
