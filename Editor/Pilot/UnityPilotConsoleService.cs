...
namespace codingriver.unity.pilot
{
    ...
    public class ConsoleLogsTailPayload
    {
        ...
        public bool excludeUnityPilot = true;
    ...
    public sealed class UnityPilotConsoleService
    {
            ...
            FieldInfo modeField)
        {
            return TryAddLogEntryCore(
                logs, index, payload.logType, payload.includeStackTrace, payload.excludeUnityPilot,
            ...
            FieldInfo modeField)
        {
            ...
            if (excludeUnityPilot && IsUnityPilotLog(msg, stackTrace))
                return false;
        ...
        private static bool IsUnityPilotLog(string message, string stackTrace)
        {
            return ContainsUnityPilot(message) || ContainsUnityPilot(stackTrace);
        }

        private static bool ContainsUnityPilot(string value)
        {
            if (string.IsNullOrEmpty(value)) return false;
            return value.IndexOf("UnityPilot", StringComparison.OrdinalIgnoreCase) >= 0
                || value.IndexOf("codingriver.unity.pilot", StringComparison.OrdinalIgnoreCase) >= 0
