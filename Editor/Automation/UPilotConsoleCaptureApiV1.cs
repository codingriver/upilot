...
{
    [Serializable]
    public sealed class ConsoleCaptureApiCapabilitiesV1
    {
    ...
    [Serializable]
    public sealed class ConsoleCaptureBoundaryResultV1
    {
        public bool ok;
    ...
    public static class UPilotConsoleCaptureApiV1
    {
        ...
        public static ConsoleCaptureApiCapabilitiesV1 Capabilities() => new()
        {
        ...
        public static ConsoleCaptureBoundaryResultV1 GetBoundary(string expectedSessionId = "")
        {
            if (s_service == null)
            ...
            return new ConsoleCaptureBoundaryResultV1
            {
                ok = true,
                sessionId = sessionId,
        ...
        private static ConsoleCaptureBoundaryResultV1 BoundaryError(string code, string message, string sessionId = "") => new()
        {
            ok = false,
            sessionId = sessionId,
            errorCode = code,
