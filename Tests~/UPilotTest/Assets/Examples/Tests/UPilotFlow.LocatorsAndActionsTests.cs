...
{
    public sealed class UPilotFlowLocatorFixtureTests : UPilotFlowFixture<SampleLoginWindow>
    {
        [UnityTest]
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteYamlStepsAsync(
        ...
        public IEnumerator ClickAction_OnLoginButton_UpdatesStatusLabel()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ClickAction(), new Dictionary<string, string>
            {
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new FocusAction(), new Dictionary<string, string>
            {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SetValueAction(), new Dictionary<string, string>
            {
                ["selector"] = "#username-input",
                ["value"] = "bob",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertValueAction(), new Dictionary<string, string>
            {
                ["selector"] = "#username-input",
                ["expected"] = "bob",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertEnabledAction(), new Dictionary<string, string>
            {
                ["selector"] = "#login-button",
            }));
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertDisabledAction(), new Dictionary<string, string>
            {
                ["selector"] = "#login-button",
            }));
        }
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertVisibleAction(), new Dictionary<string, string>
            {
                ["selector"] = "#login-button",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertTextAction(), new Dictionary<string, string>
            {
                ["selector"] = "#status-label",
                ["expected"] = "Idle",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertTextContainsAction(), new Dictionary<string, string>
            {
                ["selector"] = "#status-label",
                ["expected"] = "Id",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertNotVisibleAction(), new Dictionary<string, string>
            {
                ["selector"] = "#toast-message",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new WaitAction(), new Dictionary<string, string>
            {
                ["duration"] = "50ms",
            }));
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new WaitForElementAction(), new Dictionary<string, string>
            {
                ["selector"] = "#toast-message",
                ["timeout"] = "1000ms",
            }));
    ...
    public sealed class UPilotFlowActionFixtureTests : UPilotFlowFixture<SampleInteractionWindow>
    {
        [UnityTest]
        ...
        public IEnumerator TypeTextAndPressKeyActions_UpdateWindowState()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(typeTask);
            ...
            yield return UPilotFlowTestTaskUtility.Await(pressKeyTask);
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new PressKeyAction(), new Dictionary<string, string>
            {
                ["key"] = "A",
            }));
        ...
        public IEnumerator ExecuteAndValidateCommandActions_DispatchCommandEvents()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ValidateCommandAction(), new Dictionary<string, string>
            {
                ["command"] = "Copy",
            }));
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ExecuteCommandAction(), new Dictionary<string, string>
            {
                ["command"] = "Paste",
            }));
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new HoverAction(), new Dictionary<string, string>
            {
                ["selector"] = "#hover-target",
                ["duration"] = "50ms",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ScrollAction(), new Dictionary<string, string>
            {
                ["selector"] = "#scroll-view",
                ["delta"] = "0,120",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new DragAction(), new Dictionary<string, string>
            {
                ["from"] = "10,10",
                ["to"] = "80,80",
                ["duration"] = "64ms",
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new OpenContextMenuAction(), new Dictionary<string, string>
            {
                ["selector"] = "#context-menu-target",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertMenuItemAction(), new Dictionary<string, string>
            {
                ["item"] = "Copy",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertMenuItemDisabledAction(), new Dictionary<string, string>
            {
                ["item"] = "Delete",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectContextMenuItemAction(), new Dictionary<string, string>
            {
                ["item"] = "Copy",
            }));
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new OpenPopupMenuAction(), new Dictionary<string, string>
            {
                ["selector"] = "#popup-menu-dropdown",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectPopupMenuItemAction(), new Dictionary<string, string>
            {
                ["item"] = "Option2",
            }));
        ...
        {
            string screenshotPath = Path.Combine(Path.GetTempPath(), "UPilotFlowTests", System.Guid.NewGuid().ToString("N") + ".png");
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new TypeTextFastAction(), new Dictionary<string, string>
            {
                ["selector"] = "#interaction-input",
                ["value"] = "fast",
            }));
        ...
        public IEnumerator PressKeyCombinationAction_SendsShortcut()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new TypeTextAction(), new Dictionary<string, string>
            {
                ["selector"] = "#interaction-input",
                ["value"] = "selectme",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new PressKeyCombinationAction(), new Dictionary<string, string>
            {
                ["keys"] = "Ctrl+A",
            }));
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertPropertyAction(), new Dictionary<string, string>
            {
                ["selector"] = "#interaction-input",
                ["property"] = "maxLength",
                ["expected"] = "-1",
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ScreenshotAction(), new Dictionary<string, string>
            {
    ...
    public sealed class UPilotFlowOfficialIntegrationTests
    {
        [Test]
        public void SimulationSession_CapturesInputSystemTextEvents()
        {
            ...
            using (var session = new UPilotFlowSimulationSession())
            {
        ...
        [UnityTest]
        public IEnumerator SimulationSession_NestedOfficialHostsShareEventLifecycle()
        {
            SampleInteractionWindow window = EditorWindow.GetWindow<SampleInteractionWindow>();
            window.Show();
            yield return null;

            var first = new UPilotFlowSimulationSession();
            var second = new UPilotFlowSimulationSession();
            try
            {
                Assert.That(first.BindEditorWindowHost(window, "first"), Is.True);
                Assert.That(second.BindEditorWindowHost(window, "second"), Is.True);

                first.Dispose();

                VisualElement button = window.rootVisualElement.Q<Button>("click-button");
                Assert.That(second.TryPressKeyWithOfficialDriver(button, KeyCode.Return, new ActionContext()), Is.True);
            }
            finally
            {
                first.Dispose();
    ...
    public sealed class UPilotFlowFixtureIntegrationBoundaryTests
    {
        [UnityTest]
    ...
    public sealed class UPilotFlowStrictPointerFixtureTests : UPilotFlowFixture<SampleInteractionWindow>
    {
    ...
    public sealed class UPilotFlowStrictKeyboardFixtureTests : UPilotFlowFixture<SampleInteractionWindow>
    {
        protected override TestOptions CreateDefaultOptions()
        {
            TestOptions options = base.CreateDefaultOptions();
        ...
        public IEnumerator TypeTextAction_StrictKeyboardMode_DisablesDirectWriteFallback()
        {
            ...
            {
                UPilotFlowException flowException = ex as UPilotFlowException;
                Assert.That(flowException, Is.Not.Null);
                Assert.That(flowException.ErrorCode, Is.EqualTo(ErrorCodes.ActionTargetTypeInvalid));
                Assert.That(flowException.Message, Does.Contain("target type is not writable"));
            });
        }
    }

    public sealed class UPilotFlowStrictHostModeTests
    {
        [UnityTest]
        public IEnumerator TestRunner_StrictOfficialHost_FailsFast()
        {
            ...
            yield return UPilotFlowTestTaskUtility.AwaitFailure(task, ex =>
            {
                ...
                Assert.That(flowException.Message, Does.Contain("正式验收模式下未能创建官方测试宿主"));
            });
        }
    }

    public sealed class UPilotFlowAdvancedControlsFixtureTests : UPilotFlowFixture<AdvancedControlsWindow>
    {
        [UnityTest]
        public IEnumerator AdvancedControlActions_UpdateControlState()
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectOptionAction(), new Dictionary<string, string>
            {
                ["selector"] = "#choice-dropdown",
                ["value"] = "Beta",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ToggleFoldoutAction(), new Dictionary<string, string>
            {
                ["selector"] = "#settings-foldout",
                ["expand"] = "true",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SetSliderAction(), new Dictionary<string, string>
            {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectListItemAction(), new Dictionary<string, string>
            {
                ["selector"] = "#item-list",
                ["index"] = "2",
            }));
        ...
        public IEnumerator ToggleMaskOptionAction_TogglesIndividualBits()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ToggleMaskOptionAction(), new Dictionary<string, string>
            {
                ["selector"] = "#feature-mask",
                ["index"] = "1",
            }));
        ...
        public IEnumerator SelectOptionAction_FailsForMissingChoice()
        {
            ...
            Assert.That(task.Exception.Flatten().InnerException, Is.TypeOf<UPilotFlowException>());
            Assert.That(((UPilotFlowException)task.Exception.Flatten().InnerException).ErrorCode, Is.EqualTo(ErrorCodes.ActionOptionNotFound));
        }
        ...
        public IEnumerator SortAndResizeColumnActions_UpdateMultiColumnViews()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SortColumnAction(), new Dictionary<string, string>
            {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ResizeColumnAction(), new Dictionary<string, string>
            {
                ["selector"] = "#scene-tree",
                ["index"] = "0",
                ["width"] = "240",
        ...
        public IEnumerator BoundValueActions_ProvideHigherLevelPropertyAndInspectorAutomation()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SetBoundValueAction(), new Dictionary<string, string>
            {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new AssertBoundValueAction(), new Dictionary<string, string>
            {
                ["selector"] = "#property-title-field",
                ["property"] = "inspectorTitle",
        ...
        public IEnumerator NavigateBreadcrumbAndUnifiedMenuActions_Work()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new NavigateBreadcrumbAction(), new Dictionary<string, string>
            {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new MenuItemAction(), new Dictionary<string, string>
            {
                ["selector"] = "#toolbar-menu",
                ["kind"] = "popup",
                ["mode"] = "select",
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectTreeItemAction(), new Dictionary<string, string>
            {
                ["selector"] = "#navigation-tree",
                ["id"] = "120",
            }));

            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SelectTabAction(), new Dictionary<string, string>
            {
        ...
        {
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new DragReorderAction(), new Dictionary<string, string>
            {
                ["selector"] = "#item-list",
                ["from_index"] = "1",
                ["to_index"] = "3",
        ...
        public IEnumerator PageScrollerAndSetSplitViewSizeActions_Work()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new PageScrollerAction(), new Dictionary<string, string>
            {
                ["selector"] = "#standalone-scroller",
                ["direction"] = "down",
                ["pages"] = "2",
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new SetSplitViewSizeAction(), new Dictionary<string, string>
            {
        ...
        public IEnumerator CloseTabAction_ClosesSpecifiedTab()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new CloseTabAction(), new Dictionary<string, string>
            {
                ["selector"] = "#settings-tabs",
                ["label"] = "About",
            }));
        ...
        public IEnumerator DragScrollerAction_UpdatesScrollerValue()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new DragScrollerAction(), new Dictionary<string, string>
            {
                ["selector"] = "#standalone-scroller",
                ["ratio"] = "0.5",
                ["duration"] = "64ms",
        ...
        public IEnumerator ReadBreadcrumbsAction_PopulatesSharedBag()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ReadBreadcrumbsAction(), new Dictionary<string, string>
            {
                ["selector"] = "#toolbar-breadcrumbs",
                ["bag_key"] = "crumbs",
            }));
        ...
        public IEnumerator ClickPopupItemAction_UpdatesPopupFieldValue()
        {
            ...
            yield return UPilotFlowTestTaskUtility.Await(ExecuteActionAsync(new ClickPopupItemAction(), new Dictionary<string, string>
            {
                ["selector"] = "#quick-popup",
                ["value"] = "South",
            }));
        ...
        private static int ReadIntProperty(object target, params string[] propertyNames)
        {
            ...
            PropertyInfo selectedIdsProperty = target?.GetType().GetProperty("selectedIds", BindingFlags.Public | BindingFlags.Instance);
            if (selectedIdsProperty?.GetValue(target) is System.Collections.IEnumerable selectedIds)
            {
                foreach (object selectedId in selectedIds)
                    if (selectedId is int selectedIdValue)
                        return selectedIdValue;
            }

            PropertyInfo selectedIndexProperty = target?.GetType().GetProperty("selectedIndex", BindingFlags.Public | BindingFlags.Instance);
            PropertyInfo viewControllerProperty = target?.GetType().GetProperty("viewController", BindingFlags.Public | BindingFlags.Instance);
            if (selectedIndexProperty?.GetValue(target) is int selectedIndex && selectedIndex >= 0)
            {
                object controller = viewControllerProperty?.GetValue(target);
                MethodInfo getIdForIndex = controller?.GetType().GetMethod("GetIdForIndex", BindingFlags.Public | BindingFlags.Instance);
                if (getIdForIndex?.Invoke(controller, new object[] { selectedIndex }) is int resolvedId)
                    return resolvedId;
            }
        ...
        private static object GetIndexedMember(object collection, int index)
        {
            ...
            PropertyInfo indexer = System.Array.Find(
                collection.GetType().GetProperties(BindingFlags.Public | BindingFlags.Instance),
        ...
        {
            yield return null;
            string tempDir = Path.Combine(Path.GetTempPath(), "UPilotFlowTests", System.Guid.NewGuid().ToString("N"));
        ...
        public IEnumerator AssertMenuItemActions_FailForMissingItem()
        {
            ...
            yield return UPilotFlowTestTaskUtility.AwaitFailure(assertTask, ex =>
            {
        ...
        public IEnumerator TypeTextAction_OnNonInputElement_ThrowsOrFails()
        {
            ...
            yield return UPilotFlowTestTaskUtility.AwaitFailure(task, ex =>
            {
                Assert.That(ex, Is.TypeOf<UPilotFlowException>().Or.TypeOf<System.Exception>());
            });
        }
    }
}
