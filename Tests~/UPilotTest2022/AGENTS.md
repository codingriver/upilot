...
generatedAt: 2026-09-23T09:24:00Z
...
- Streamable HTTP: `http://127.0.0.1:8017/mcp`
...
3. Verify `paths.unityProjectAbsolute` matches `D:\upilot\Tests~\UPilotTest2022` (allow equivalent slash normalization).
