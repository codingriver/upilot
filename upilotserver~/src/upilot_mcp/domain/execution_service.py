...
class ExecutionDomainService:
    ...
    async def csharp_object_dump(
        ...
        expand_unity_value_types: bool = False,
        expand_reflection_types: bool = False,
        ...
        return await self.dispatcher.call(request_id, "csharp.objectDump", {
            ...
            "includeTypeNames": include_type_names,
            "expandUnityValueTypes": expand_unity_value_types,
            "expandReflectionTypes": expand_reflection_types,
